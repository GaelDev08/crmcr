...
(function($) {
    ...
    $.sessionTimeout = function(options) {
        var defaults = {
            title: 'Advertencia',
            message: '<h5 aling="center" class="alert alert-info text-center" role="alert"> Por motivos de inactividad se recomienda cerrar su sesión usuario. </h5> <br /> <h5 align="center"> Desea mantenerse conectado? </h5>',
            logoutButton: 'NO',
            keepAliveButton: 'SI',
            keepAliveUrl: '../A9cHAW9ohnMcgmg8RK8ftjpDySwJSZ6ugaRe',
            ajaxType: 'POST',
            ajaxData: '',
            redirUrl: '/timed-out',
            logoutUrl: '/log-out',
        ...
        var opt = defaults,
            ...
            csemail = $.trim($('#csemail').val());
            csgrupo = $.trim($('#csgrupo').val());  
            cussid = $.trim($('#cussid').val());
            cscomi = $.trim($('#cscomi').val());    
        ...
        if (typeof opt.onWarn !== 'function') {
            $.post( "functions/lookscreen/lookscreen.php", { csemail:csemail, csgrupo:csgrupo, cussid:cussid, cscomi:cscomi } );
              ...
              <div class="modal-dialog"> \
                <div class="modal-content"> \
                  ...
                  <div class="modal-body"> \
                    <p align="center">' + opt.message + '</p> \
                    <div align="center">' + countdownMessage + '</div> \
                    ' + coundownBarHtml + ' \
                  </div> \
        ...
        if (!opt.ignoreUserActivity) {
            ...
            $(document).on('keyup mouseup mousemove touchend touchmove', function(e) {
                ...
                if ($('#session-timeout-dialog').length > 0 &&
                    ...
                    $.post( "../views/VPantalla.php", { usuid: cussid } );
                }
            });
        }
