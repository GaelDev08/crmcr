$(document).ready(function() {
  ...
  function listar(){
    ...
    $.ajax({
         url: "functions/Equipos/Equipos.php",
         type: "POST",
         datatype:"json",
                  ...
                  "autoWidth"   : false,
                   ...
                   "columnDefs": [
                   {
                    ...
                    "render": function (data, type, row, meta) {
                      return '<span style="display: block;margin: auto;text-align: center;" data-id="'+row.equi_id+'" >'+row.equi_id+'</span>';
                      }
                    }
                 ]
               });
...
$('#formCategoria').submit(function(e){
  ...
  $.ajax({    
         ...
         type: "POST",
         datatype:"json",
         data:  {opcion:opcion,mnombre:mnombre, empid:empid},
         success: function(data)
         {
...
$('#formECategoria').submit(function(e){
   ...
   $.ajax({
          ...
          type: "POST",
          datatype:"json",
          data:  {opcion:opcion,eid:eid,emnombre:emnombre},
          success: function(data) {
            toastr.success('Se han procesado los datos correctamente','EXITO');
            listar();
          }
