...
<div class="row" id="principal">
    ...
    <input type="hidden" id="tipofil" value="C">
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
              <div class="row" style="border-bottom:1px solid #021130;">
                <div class="col-lg-6">
                  <h4 ><i class="fas fa-search"></i>&nbsp;Reporte <small>Clientes</small> </h4>
                </div>
                ...
                <table class="table datatable table-striped table-bordered nowrap" id="datacli" style="width: 100%;">
                    <thead class="thead"  style="background:#343a40; color: white;">
                        <tr class="text-center bg-dark">
                            ...
                            <th style="color: white;">Nuevos</th>
                            <th style="color: white;">Atendidos</th>
                            <th style="color: white;">Terminados</th>
                            <th style="color: white;">Detalles</th>
                        </tr>
                    </thead>
                    <tbody class="text-center BusquedaRapida">    
                    </tbody>
                </table>	
                </div>
            </div>
