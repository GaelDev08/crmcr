<div class="modal fade" id="D_Categoria" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Configurar Categoria</h5>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="bcatnom" id="bcatnom">
